<template>
  <div class="movie-card">
    <div class="poster">
      <!-- Poster anzeigen, wenn verfügbar -->
      <img 
        v-if="posterUrl" 
        :src="posterUrl" 
        :alt="title.name" 
        class="poster-image"
      >
      <!-- Platzhalter anzeigen, wenn kein Poster vorhanden -->
      <div
        v-else
        class="no-poster"
      >
    ...
    <div class="info">
      <!-- Titel des Films oder der Serie -->
      <h3 class="title">
        {{ title.name }}
      </h3>
      <!-- Bewertung nur anzeigen, wenn showRating true ist -->
      <div
        v-if="showRating"
        class="rating"
      >
      ...
      <!-- Übersicht (Beschreibung) anzeigen, falls vorhanden -->
      <p
        v-if="title.overview"
        class="overview"
      >
      ...
      <div class="actions">
        <!-- Aktionen per Slot einfügbar -->
        <slot name="actions" />
        <!-- "Bewerten"-Button, wenn noch nicht bewertet und Rating nicht angezeigt wird -->
        <router-link 
...
// Erzeugt die vollständige Poster-URL, wenn ein Pfad vorhanden ist
...
// Kürzt die Übersicht auf max. 150 Zeichen
...
// Formatiert die Gesamtbewertung
